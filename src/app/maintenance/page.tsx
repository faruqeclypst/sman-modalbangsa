      ...
      <div className="w-full md:w-1/2 h-full flex flex-col justify-center p-8 sm:p-12 md:p-24 relative z-10 bg-[#faf9f6]">
        <div className="max-w-lg w-full mx-auto space-y-10 animate-slide-up">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <span className="text-[10px] sm:text-xs uppercase tracking-[0.2em] text-emerald-800 font-bold block">
                Portal Resmi
              </span>
              <h2 className="text-xs sm:text-sm font-bold text-slate-800 font-sfpro">
